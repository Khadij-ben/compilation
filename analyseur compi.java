...
/*********************************************************************************************************************/
	...
	public String syntax(String chaine){
		...
		if(chaine.equals("Snl_Start")) return "Début du programme";
		...
		else if(chaine.equals("Snl_Close ")) return "Fin du programme";
...
/*********************************************************************************************************************/
	...
	public String semantique(String chaine){
		if(chaine.equals("Snl_Start")) return "public static void main(String[] args) {";
		...
		else if(chaine.startsWith("Snl_Put \" ") && chaine.endsWith(" \" %.")) return "System.out.println(\"Affichage d'un message à l'ecran\");";
		else if(chaine.contains(" ")) {
			mot = chaine.split(" ");
			int i=0;
